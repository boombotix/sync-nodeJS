...
/*
    ...
    function getDjPlaylist(playlistOrder,userId,callback)
    {
        ...
        if (playlistOrder == "") {
            ...
            var sql = "SELECT playlist_id,song_name,song_artist,song_image,song_link,song_itunes_link,session_id,song_status,duration FROM tb_user_playlist WHERE user_id=? and song_name!=? ORDER BY playlist_created_datetime desc";
            ...
            var sql = "SELECT playlist_id,song_name,song_artist,song_image,song_link,song_itunes_link,session_id,song_status,duration FROM tb_user_playlist WHERE user_id=? and song_name!=? ORDER BY FIELD(playlist_id,"+playlistOrder+")";
            connection.query(sql, [userId, ''], function(err, responseDj) {
