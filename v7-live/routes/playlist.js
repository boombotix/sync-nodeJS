...
exports.addPlayListSongFromUserIdSessionIdChannelId = function(req, res) {
    ...
    var manValues = [accessToken, songName, songArtist, songLink1, songItunesLink, songImageUrl, songStatuses];
                            ...
                            connection.query(sql, [userId], function(err, responseSessionId) {
                                ...
                                for (var a = 0; a < goodSongsLength; a++)
                                {
                                    (function(a) {
                                        ...
                                        savingPlaylistInDb(flag, userId, songName[n], songArtist[n], songImageUrl[n], songLink[n], songItunesLink[n], sessionId, songStatuses[n], function(songId)
                                        {
...
exports.mailChimp = function(req, res) {
    var sql = "SELECT user_name,user_fb_email FROM tb_users where user_fb_id!=0";
...
if(results[i].user_email != '')
    {
var merge_vars = {
    FNAME: results[i].user_name
    
};


var params = {'id':'f3cf1de3d4','email_address':results[i].user_fb_email,'merge_vars':merge_vars};
